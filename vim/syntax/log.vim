...
" highlight link iisw3c_date Function ctermfg=red
highlight iisw3c_date cterm=bold ctermfg=10 ctermbg=17 gui=none guifg=bg guibg=Red
...
" OpenStack log specifics
syntax match rpc_request /req-\w\{8}\-\w\{4}\-\w\{4}\-\w\{4}\-\w\{12}/
highlight rpc_request cterm=bold ctermfg=Yellow 
